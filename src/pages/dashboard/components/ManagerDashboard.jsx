...
const ManagerDashboard = ({ managerState, navigate }) => (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard
                title="Active Squad"
                value={managerState.teamStats?.activeMembers?.length || '12'}
                icon={Users}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-premium overflow-hidden">
                ...
                <div className="space-y-6 overflow-y-auto max-h-[260px] pr-2">
                    {[
                        { name: 'Alex Rivera', prod: 94, role: 'Eng' },
                        { name: 'Sarah Chen', prod: 88, role: 'Des' },
                        { name: 'James Wilson', prod: 72, role: 'Eng' },
                        { name: 'Elena Petrova', prod: 91, role: 'QA' },
                    ].map((m, i) => (
                        <div key={i} className="flex items-center justify-between group">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs font-black text-slate-900 uppercase tracking-tight">{m.name}</p>
            ...
            <div className="p-0 overflow-x-auto">
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-50">
                        {[
                            { id: 1, name: 'Alex Rivera', prod: 94, idle: '12m', status: 'Active' },
                            { id: 2, name: 'Sarah Chen', prod: 88, idle: '45m', status: 'In Meeting' },
                            { id: 3, name: 'James Wilson', prod: 72, idle: '1h 20m', status: 'Idle' },
                            { id: 4, name: 'Elena Petrova', prod: 91, idle: '8m', status: 'Active' },
                        ].map(member => (
